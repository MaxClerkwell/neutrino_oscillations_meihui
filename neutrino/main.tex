...
\vspace{0.4cm}
\centering
\includegraphics[height=4.5cm]{neutrinos_header.jpg}
\end{frame}
...
\begin{columns}
    \column{0.5\textwidth}
    \centering
    \includegraphics[height=3.5cm]{beta.png}

    \column{0.5\textwidth}
    \centering
    \includegraphics[height=4.5cm]{beta_energy_spectrum.png}
\end{columns}
\end{frame}
...
\centering
\includegraphics[width=\textwidth]{neutrinos.png}
\end{column}
\end{columns}
...
\begin{columns}
    ...
    \centering
    \includegraphics[height=3.5cm]{PrincipeExpCowan_En.jpg}
%    \begin{itemize}
...
%    \end{itemize}
    ...
    \column{0.3\textwidth}
    \centering
    \includegraphics[height=2.5cm]{RC1.jpeg}
    \vspace{0.3cm}
    \includegraphics[height=3cm]{RC2.jpeg}
\end{columns}
\end{frame}
% =================================================
...
\centering
\includegraphics[height=7cm]{oscillation_.png}
\end{frame}
...
\begin{center}
\includegraphics[height=3cm]{PMNS.png}
\end{center}
\end{frame}
...
\centering
\includegraphics[height=3cm]{changing.jpg}
\end{frame}
...
\centering
\includegraphics[width=\textwidth]{ka.jpg}

\vspace{0.3cm}

\includegraphics[width=\textwidth]{su.jpg}
\end{column}
\end{columns}
\end{frame}
...
\end{itemize}
    ...
    \begin{columns}
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{cosmic-ray-atmospheric-neutrino-generation.jpg}
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{Screenshot 2026-06-16 at 01.02.24.png}
    \end{columns}
\end{frame}
...
\vspace{1cm}
    \begin{columns}
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{detector_main.png}
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{sk_hero_01.jpg}
    \end{columns}
\end{frame}
...
$\nu_\mu + n \rightarrow \mu^- + p$
    \begin{center}
        \includegraphics[width=0.85\textwidth]{super-k.jpeg}
    \end{center}
...
\end{itemize}
    \centering
    \includegraphics[width=0.83\textwidth]{zenith.png}
...
\end{itemize}
    ...
    \includegraphics[width=0.9\textwidth]{Data:MC.png}
\end{frame}
...
\begin{columns}
    ...
    \column{0.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{CC-NC-ES-reactions-in-SNO_W640.jpg}
    \end{columns}
...
\begin{frame}{Detection}
\centering
    \includegraphics[width=0.95\textwidth]{123.png}
    \vspace{1em}
    \begin{itemize}
...
\begin{columns}
    \column{0.5\textwidth}
    \centering
    \includegraphics[width=0.75\textwidth]{Sudbury_Neutrino_Observatory.detector_outside.jpg}
    \column{0.5\textwidth}
    \centering
    \includegraphics[width=0.85\textwidth]{sno_layout.png}
\end{columns}
\end{frame}
...
\centering
        \includegraphics[width=0.9\textwidth]{sno.png}
\end{frame}
...
\centering
        \includegraphics[width=0.85\textwidth]{fluxes.png}
\end{frame}
